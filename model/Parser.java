...
public class Parser {
    ...
    public Command parse(String command) {
        ...
        try {
            if (splitCommand[0].equals("stop")) {
                return Command.STOP;
            }

            if (splitCommand[0].equals("click")) {
                if (splitCommand[1].equals("left")) {
                    return Command.CLICK_LEFT;
                }
                if (splitCommand[1].equals("right")) {
                    return Command.CLICK_RIGHT;
                }
                if (splitCommand[1].equals("center")) {
                    return Command.CLICK_CENTER;
                }
            }

            if (splitCommand[0].equals("press")) {
                if (splitCommand[1].equals("right")) {
                    return Command.PRESS_RIGHT;
                }
                if (splitCommand[1].equals("left")) {
                    return Command.PRESS_LEFT;
                }
                if (splitCommand[1].equals("center")) {
                    return Command.PRESS_CENTER;
                }
            ...
            if (splitCommand[0].equals("release")) {
                if (splitCommand[1].equals("right")) {
                    return Command.RELEASE_RIGHT;
                }
                if (splitCommand[1].equals("left")) {
                    return Command.RELEASE_LEFT;
                }
                if (splitCommand[1].equals("center")) {
                    return Command.RELEASE_CENTER;
                }
                if (splitCommand[1].equals("key")) {
                    //In the beginning nonvalid keycodes. The previous ones get deleted
